...
ins_pl = pn.cross("a[A_STEM][Masc][Ins][Pl]", "ais") | pn.cross("a[A_STEM][Masc][Ins][Pl]", "ebhis")
...
ins_pl_n = pn.cross("a[A_STEM][Neut][Ins][Pl]", "ais") | pn.cross("a[A_STEM][Neut][Ins][Pl]", "ebhis")
